...
#     mock_data[:instance_profiles] = 'test1'
#     data[:data] = { :iam_client => [mock_data] }
#     data[:client] = Aws::IAM::Client
#     @iam_client = AWSIAMInstanceProfiles.new(instance_profiles: 'test1', client_args: { stub_responses: true }, stub_data: [data])
#   end
