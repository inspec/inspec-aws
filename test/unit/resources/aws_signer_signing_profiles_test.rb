...
#     assert_raises(ArgumentError) { AWSSignerSigningProfiles.new(client_args: { stub_responses: true }) }
#   end
#
...
#   end
#
#   def test_signing_materials
#     assert_equal(@resp.signing_materials, ['test1'])
#   end
#
#   def test_signature_validity_periods
#     assert_equal(@resp.signature_validity_periods, [{}])
#   end
#
