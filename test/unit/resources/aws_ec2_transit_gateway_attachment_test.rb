...
class AwsEc2TransitGatewayAttachmentConstructorTest < Minitest::Test
  ...
  def test_accepts_transit_gateway_attachment_id_as_hash_eight_sign
    AwsEc2TransitGatewayAttachment.new(transit_gateway_attachment_id: 'tgw-attach-0123456789', client_args: { stub_responses: true })
  end
...
class AwsEc2TransitGatewayAttachmentPathTest < Minitest::Test
  ...
  def setup
    ...
    @addr = AwsEc2TransitGatewayAttachment.new(transit_gateway_attachment_id: 'tgw-attach-006f2fd0a03d51323',client_args: { stub_responses: true }, stub_data: [data])
  end
  ...
  def test_transit_gateway_id
    assert_equal(@addr.transit_gateway_id, 'tgw-02850dffe1c3b222c')
  end

  def test_transit_gateway_owner_id
    assert_equal(@addr.transit_gateway_owner_id, '112758395563')
  end

  def test_resource_owner_id
    assert_equal(@addr.resource_owner_id, '112758395563')
  end
  ...
  def test_resource_id
    assert_equal(@addr.resource_id, 'vpc-08b86815ee2c22d53')
  end
