require 'helper'
require 'aws_api_gateway_client_certificate'
...
class AWSApiGatewayClientCertificateConstructorTest < Minitest::Test
  ...
  def test_empty_param_arg_not_ok
    assert_raises(ArgumentError) { AWSApiGatewayClientCertificate.new(api_mapping_id: '', domain_name: '', client_args: { stub_responses: true }) }
  end
...
class AWSApiGatewayClientCertificateuccessPathTest < Minitest::Test
  ...
  def setup
    ...
    mock_data[:expiration_date] = Time.parse("2013-08-12T23:52:02Z2020-06-05T11:30:39.730000+01:00")
    mock_data[:tags] = {}
    data[:data] = [mock_data]
  ...
  def test_created_date
    assert_equal(@resp.created_date, Time.parse("2013-08-12T23:52:02Z2020-06-05T11:30:39.730000+01:00"))
  end

  def test_expiration_date
    assert_equal(@resp.expiration_date, Time.parse("2013-08-12T23:52:02Z2020-06-05T11:30:39.730000+01:00"))
  end
