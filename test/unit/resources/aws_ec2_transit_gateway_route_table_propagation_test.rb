...
class AWSEc2TransitGatewayRouteTablePropagationConstructorTest < Minitest::Test
  ...
  def test_empty_param_arg_not_ok
    assert_raises(ArgumentError) { AWSEc2TransitGatewayRouteTablePropagation.new(transit_gateway_route_table_id: '', client_args: { stub_responses: true }) }
  end
...
class AWSEc2TransitGatewayRouteTablePropagationSuccessPathTest < Minitest::Test
  ...
  def setup
    ...
    @transit_gateway_route_table_propagations = AWSEc2TransitGatewayRouteTablePropagation.new(transit_gateway_route_table_id: 'test1', client_args: { stub_responses: true }, stub_data: [data])
  end
