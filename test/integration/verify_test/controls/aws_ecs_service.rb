...
aws_service_id = attribute(:aws_service_arn, value: '', description: '')
aws_service_arn = attribute(:aws_service_arn, value: '', description: '')
aws_service_name = attribute(:aws_service_name, value: '', description: '')
aws_cluster_arn = attribute(:aws_cluster_arn, value: '', description: '')
aws_task_definition_arn = attribute(:aws_task_definition_arn, value: '', description: '')

control 'aws-ecs-service-1.0' do
  impact 1.0
  title 'Ensure AWS ECS Service has the correct properties.'

  describe aws_ecs_service(cluster: aws_cluster_name, services: [aws_service_arn]) do
      it { should exist }
  end
end
...
control 'aws-ecs-service-1.0' do
  ...
  describe aws_ecs_service(cluster: aws_cluster_name, services: [aws_service_arn]) do
      ...
      its('task_definition') { should eq aws_task_definition_arn }
