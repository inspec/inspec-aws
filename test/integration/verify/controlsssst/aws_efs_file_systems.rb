...
aws_efs_company_name = attribute(:aws_efs_company_name, value: "", description: "The EFS File System company name tag.")
aws_efs_count = attribute(:aws_efs_count, value: "", description: "The number of EFS File Systems.")
