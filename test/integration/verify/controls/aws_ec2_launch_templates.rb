aws_launch_template_name = attribute(:aws_launch_template_name, value: '', description: 'The AWS  Launch Template Name.')
...
control 'aws-launch-templates-1.0' do
  ...
  describe aws_ec2_launch_templates do
    ...
    its('launch_template_name') { should include aws_launch_template_name  }
  end
end
