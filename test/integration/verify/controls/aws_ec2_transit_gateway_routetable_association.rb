...
control 'aws-rc2-transit-gateway-routetable-association-v1.0.0' do
  impact 1.0
  title 'Gets information about the associations for the specified transit gateway route table.'
  describe aws_ec2_transit_gateway_routetable_association(transit_gateway_attachment_id: aws_transit_gateway_attachment_id) do
    it { should exist }
