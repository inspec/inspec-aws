...
state = attribute(:state, value: '', description: 'The state of the route table (available | deleting | deleted | pending).')
default_association_route_table = attribute(:default_association_route_table, value: '', description: 'Indicates whether this is the default association route table for the transit gateway (true | false).')
default_propagation_route_table = attribute(:default_propagation_route_table, value: '', description: 'Indicates whether this is the default propagation route table for the transit gateway (true | false)')
creation_time = attribute(:creation_time, value: '', description: 'The creation time of the transit gateway route table.')
tags = attribute(:tags, value: '', description: 'The tags of the transit gateway route table.')
