aws_transit_gateway_attachment_id = attribute(:aws_transit_gateway_attachment_id_association, value: '', description: 'The IDs of the attachments.')
aws_resource_id = attribute(:aws_transit_gateway_attachment_vpc_id_association, value: '', description: 'The ID of the resource.')
aws_transit_gateway_route_table_id = attribute(:aws_transit_gateway_route_table_id_association, value: '', description: 'The ID of the route table for the transit gateway.')
