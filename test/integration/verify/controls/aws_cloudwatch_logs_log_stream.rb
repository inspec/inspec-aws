...
aws_cloudwatch_log_group_name = attribute('aws_cloudwatch_log_group_name', value: '(none)', description: '')
...
control 'aws_cloudwatch_logs_log_stream-1.0' do
  ...
  describe aws_cloudwatch_logs_log_stream(log_stream_name_prefix: aws_cloudwatch_log_stream_name, log_group_name: aws_cloudwatch_log_group_name) do
    it { should exist }
