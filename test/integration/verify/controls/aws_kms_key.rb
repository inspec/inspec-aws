...
aws_key_description_enabled = attribute(:aws_key_description_enabled, value: '', description: 'The AWS KMS key description.')
aws_key_description_disabled = attribute(:aws_key_description_disabled, value: '', description: 'The AWS KMS key description.')
