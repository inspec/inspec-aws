...
control 'aws_ec2_network_interface_permission-1.0' do

  impact 1.0
  title 'Ensure AWS Network Interface permission has the correct properties.'

  describe describe aws_ec2_network_interface_permission(network_interface_permission_id: 'NetworkInterfacePermissionId') do
    it { should exist }
