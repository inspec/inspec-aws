...
aws_config_recorder_role_arn = attribute(:aws_config_recorder_role_arn, value: '', description: 'The AWS Config Recorder ARN.')
aws_configuration_recorder_name = attribute(:aws_configuration_recorder_name, value: '', description: 'The AWS Config Recorder name.')
