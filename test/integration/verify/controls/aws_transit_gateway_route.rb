...
transit_gateway_route_table_id = attribute(:aws_transit_gateway_route_table_id, value: '', description: 'The AWS Transit Gateway Route Table ID.')
cidr_block = attribute(:tgw_route_cidr_block, value: '', description: 'CIDR Block for the route')
