...
skip_control 'aws_ec2_client_vpn_endpoint-1.0' do
  ...
  describe aws_ec2_client_vpn_endpoint(client_vpn_endpoint_id: client_vpn_endpoint_id) do
    ...
    its('dns_name') { should_not eq '*.cvpn-endpoint-9999999999.prod.clientvpn.us-east-2.amazonaws.com' }
    ...
    its('server_certificate_arn') { should_not eq 'arn:aws:acm:us-east-2:999999999999:certificate/a20fe841-b1ef-4785-aefb-e69838eacdcb' }
  end
end