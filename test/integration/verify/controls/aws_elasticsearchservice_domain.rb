aws_elasticsearch_domain_name = attribute(:aws_elasticsearch_domain_name, value: '', description: '')
aws_elasticsearch_domain_id = attribute(:aws_elasticsearch_domain_id, value: '', description: '')
aws_elasticsearch_domain_arn = attribute(:aws_elasticsearch_domain_arn, value: '', description: '')
aws_elasticsearch_version = attribute(:aws_elasticsearch_version, value: '', description: '')
