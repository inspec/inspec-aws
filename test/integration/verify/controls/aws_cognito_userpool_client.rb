...
aws_client_secret = attribute("aws_client_secret", default: "t20j6pafdrt7u89r4sq0oo7q7dmcc5mcrrlho4a24fibhvqe7e1", description: "")
...
aws_explicit_auth_flows = attribute("aws_explicit_auth_flows", default: "ALLOW_CUSTOM_AUTH", description: "")
aws_allowed_o_auth_flows_user_pool_client = attribute("aws_allowed_o_auth_flows_user_pool_client", default: false, description: "")
aws_prevent_user_existence_errors = attribute("aws_prevent_user_existence_errors", default: "ENABLED", description: "")
