aws_name = attribute("aws_name", default: "test1", description: "")
aws_state = attribute("aws_state", default: "ENABLED", description: "")
aws_description = attribute("aws_description", default: "test1", description: "")
...
aws_configuration_enforce_work_group_configuration = attribute("aws_configuration_enforce_work_group_configuration", default: false, description: "")
aws_configuration_publish_cloud_watch_metrics_enabled = attribute("aws_configuration_publish_cloud_watch_metrics_enabled", default: true, description: "")
...
aws_configuration_requester_pays_enabled = attribute("aws_configuration_requester_pays_enabled", default: false, description: "")
aws_configuration_engine_version_selected_engine_version = attribute("aws_configuration_engine_version_selected_engine_version", default: "AUTO", description: "")
aws_configuration_engine_version_effective_engine_version = attribute("aws_configuration_engine_version_effective_engine_version", default: "Athena engine version 1", description: "")
