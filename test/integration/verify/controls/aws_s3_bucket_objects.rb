aws_s3_bucket_object_public = value(:aws_s3_bucket_object_public, default: '', description: 'The AWS bucket object key.')
aws_bucket_public_objects_name = value(:aws_bucket_public_objects_name, default: '', description: 'The AWS bucket.')
