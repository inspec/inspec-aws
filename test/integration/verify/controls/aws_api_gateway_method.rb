control 'aws-auto-scaling-method-1.0' do
    impact 1.0
    title 'Ensure AWS Auto Scaling Method has the correct properties.'
  
    describe aws_api_gateway_method(rest_api_id: 'zq945ecmb4', resource_id: 'cyfyyevuy7', http_method: 'GET') do
        it { should exist }
    end
    ...
    describe aws_api_gateway_method(rest_api_id: 'zq945ecmb4', resource_id: 'cyfyyevuy7', http_method: 'GET') do
        ...
        its('method_integration.cache_namespace') { should eq 'cyfyyevuy7' }
