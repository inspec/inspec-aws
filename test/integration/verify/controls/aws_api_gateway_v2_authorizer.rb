aws_apigatewayv2_authorizer_id = input(:aws_apigatewayv2_authorizer_id, value: '', description: '')
aws_apigatewayv2_authorizer_api_id = input(:aws_apigatewayv2_authorizer_api_id, value: '', description: '')
aws_apigatewayv2_authorizer_authorizer_type = input(:aws_apigatewayv2_authorizer_authorizer_type, value: '', description: '')
aws_apigatewayv2_authorizer_identity_sources = input(:aws_apigatewayv2_authorizer_identity_sources, value: '', description: '')
aws_apigatewayv2_authorizer_jwt_configuration_audience = input(:aws_apigatewayv2_authorizer_jwt_configuration_audience, value: '', description: '')
aws_apigatewayv2_authorizer_jwt_configuration_issuer = input(:aws_apigatewayv2_authorizer_jwt_configuration_issuer, value: '', description: '')
aws_apigatewayv2_authorizer_name = input(:aws_apigatewayv2_authorizer_name, value: '', description: '')
