...
control 'aws_ec2_client_vpn_endpoints-1.0' do
  ...
  describe aws_ec2_client_vpn_endpoints do
    ...
    its('dns_names') { should_not include '*.cvpn-endpoint-99999999999.prod.clientvpn.us-east-2.amazonaws.com' }
    ...
    its('server_certificate_arns') { should_not include 'arn:aws:acm:us-east-2:9999999999:certificate/a20fe841-b1ef-4785-aefb-e69838eacdcb' }
  end
end
